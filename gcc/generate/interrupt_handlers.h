...
// DEU DEU0
void INT_Excep_DEU_DEU0(void) __attribute__ ((interrupt));

// DEU DEU1
void INT_Excep_DEU_DEU1(void) __attribute__ ((interrupt));

// PDC PCDFI
void INT_Excep_PDC_PCDFI(void) __attribute__ ((interrupt));

// PDC PCFEI
void INT_Excep_PDC_PCFEI(void) __attribute__ ((interrupt));

// PDC PCERI
void INT_Excep_PDC_PCERI(void) __attribute__ ((interrupt));
